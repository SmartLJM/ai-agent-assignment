    ...
    evidence = {
        ...
        "optional_modules": {
            ...
            "status": "pass" if (
                ...
                and summary.get("workflow_templates", 0) >= 3
                and set(summary.get("workflow_modes", [])) == {"sequential", "parallel", "conditional"}
                and summary.get("orchestration_passed") == summary.get("orchestration_questions")
            ...
            "presentation_evidence": [
                ...
                f"{summary.get('workflow_templates', 0)} 个工作流模板",
                f"编排模式：{summary.get('workflow_modes', [])}",
                f"编排评测：{summary.get('orchestration_passed', 0)}/{summary.get('orchestration_questions', 0)}",
